...
class MainActivity : AppCompatActivity() {
    ...
    private fun primaryButton(text: String, onClick: () -> Unit): Button {
        return button(text, COLOR_PRIMARY, 0xffffffff.toInt(), onClick, null)
    }

    private fun primaryButton(text: String, onClick: () -> Unit, iconRes: Int): Button {
    ...
    private fun secondaryButton(text: String, onClick: () -> Unit): Button {
        return button(text, 0xffe2e8f0.toInt(), COLOR_TEXT, onClick, null)
    }

    private fun secondaryButton(text: String, onClick: () -> Unit, iconRes: Int): Button {
