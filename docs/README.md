# Movara documentation

**If you are new to this repo (or an AI agent):** read the [main README](../README.md) first for what the project is and how to run it. Then use these docs for deeper context.
